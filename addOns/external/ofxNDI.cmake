...
set( NAME_ADDON     ofxNDI )       # <--- Set the name here
...
if(APPLE)
	set(libndi "${PATH_LIBS}/NDI/lib/osx/x64/libndi.4.dylib" )
	target_link_libraries( ofxNDI ${libndi} ${CMAKE_DL_LIBS})
elseif(UNIX)
	set(libndi "${PATH_LIBS}/NDI/lib/linux/x86_64-linux-gnu/libndi.so" )
	target_link_libraries( ofxNDI ${libndi} ${CMAKE_DL_LIBS})
endif()